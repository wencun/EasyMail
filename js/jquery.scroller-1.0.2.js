...
(function ($) {
    ...
    function Scroller(elm, dw, settings) {
        ...
        this.pos = function() {
            var totalw = 0;
            var minw = 0;
            var ww = $(methods.mainSetting.orignPagePosition).parent().width();
            var wh = $(methods.mainSetting.orignPagePosition).parent().height();

            var st = $(methods.mainSetting.orignPagePosition).parent().scrollTop();
            var w;
            var h;
            $('.dwc', dw).each(function() {
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            if ($('.dwo').length) {
                ...
                dw.hide().appendTo(settings.orignPagePosition);
